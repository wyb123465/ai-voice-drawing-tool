...
[![Tests](https://img.shields.io/badge/tests-64%20passed-success)](https://github.com/wyb123465/ai-voice-drawing-tool)
...
- 🗣️ **澄清追问**：对“整个三角形上去”“把它上去”“把这个圆上去”这类低置信表达先反问，听到“对”后再执行；点名不存在的形状不会进入澄清
- 🔒 **白名单校验**：云端开放输出必须过形状/颜色/位置白名单，非法值就近回退默认
- 🎬 **演示模式**：`?llmdemo=1` 无需真密钥即可演示完整云端链路
- 🧪 **64 个测试全过**：覆盖解析、状态、渲染、兜底、澄清追问、网络异常等关键路径
